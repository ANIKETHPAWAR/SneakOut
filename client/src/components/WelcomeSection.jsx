...
const WelcomeSection = ({ user }) => {
  return (
    <div className="relative max-w-7xl mx-auto mb-8">
      <div className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 rounded-2xl p-8 text-center text-white min-h-[32rem] overflow-hidden">
        <div className="absolute inset-0 z-0">
          <AnimateBlob />
        </div>
        <div className="relative z-10">
          <h1 className="text-4xl sm:text-5xl font-bold mb-10 py-5">
          ...
          {/* Stats Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mt-15 max-w-3xl mx-auto">
