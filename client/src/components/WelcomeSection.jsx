...
import AnimateBlob from './animationBlob';
const WelcomeSection = ({ user }) => {
  return (
    <div className="relative max-w-7xl mx-auto mb-8">
      <div className="relative bg-app-gradient rounded-2xl p-8 text-center text-white min-h-[28rem] overflow-hidden">
        <div className="absolute inset-0 z-0">
          <AnimateBlob />
        </div>
        <div className="relative z-10">
          <h1 className="text-4xl sm:text-5xl font-bold mb-6 py-2">
            Welcome back, <span className="text-yellow-300">{user?.firstName || 'Explorer'}!</span>
          </h1>
          <p className="text-lg sm:text-xl text-purple-100/90 max-w-2xl mx-auto mb-6">
            Discover hidden gems, amazing photo locations, and adventure trails that only locals know about.
          </p>
          
          {/* Stats Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mt-10 max-w-3xl mx-auto">
